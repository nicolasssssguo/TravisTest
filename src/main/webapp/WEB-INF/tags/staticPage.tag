      ...
      <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbar-collapse-1">
            ...
            <form class="navbar-form navbar-right" action="/login" name="login" onsubmit="return x();">
              <input type="submit" name="instructor" class="btn btn-login" id="btnInstructorLogin" value="Login" label="Login">
            </form>
          </div>
        </div>
      </nav>
