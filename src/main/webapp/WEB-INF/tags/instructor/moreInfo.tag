  ...
  <div class="col-xs-12">
    <div class="panel panel-default">
      <div class="panel-body">
        <a class="btn btn-default btn-xs btn-tm-actions session-copy-for-test margin-bottom-7px" id="good" href="javascript:;">
          <img src="/images/icon_good.png" alt="" style="width: 15px;margin-bottom: 2px;"><span>(10)</span>
        </a>
